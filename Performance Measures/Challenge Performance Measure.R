...
stacked_ensemble_h2o <- h2o.getModel("StackedEnsemble_AllModels_3_AutoML_2_20230623_160327")
...
h2o.getModel("StackedEnsemble_AllModels_3_AutoML_2_20230623_160327") %>% 
  h2o.saveModel(path = "AutoML 2/Models/")
##-----------------------------------------------------------------------
### NEW PART: Performance Measures 
# -01 Leaderbord visualization-
...
# -02 Tune a model with grid search-
h2o.init()
...
h2o.getModel("deeplearning_grid_01_model_6") %>% 
  h2o.saveModel(path = "AutoML 2/Models/")
# -03 Visualize the trade between the precision and the recall and the optimal threshold-

...
![Leaderboard](../../Performance Measures/Leaderbord Metrics.png)
...
![Leaderboard](../../Performance Measures/grid search.png)

## -Visualize the trade between the precision and the recall and the optimal threshold-
```
...
performance_tbl %>%
  ...
  theme_new
```
Depicted below is the Precision vs. Recall plot.
![Precision vs. Recall](../../Performance Measures/precision vs recall.png)
Additionally, also the confusion matrix.
Console output:
```
> h2o.confusionMatrix(stacked_ensemble_h2o)
...
![ROC Plot](../../Performance Measures/roc plot.png)
...
```
The resulting plot is depicted below.
![Recall vs. Precision](../../Performance Measures/precision vs recall plot richtig.png)
...
![Gain plot](../../Performance Measures/gain.png)
...
![Gain plot](../../Performance Measures/lift.png)
...
![Dashboard](../../Performance Measures/dashboard.png)
